...
echo -n -e "${YELLOW}Enter MON_IDENT :${RESET} " 
read MON_IDENT

echo -n -e "${YELLOW}Enter CLUSTER :${RESET} " 
read CLUSTER

echo -n -e "${YELLOW}Enter ORD_IDENT :${RESET} " 
read ORD_IDENT

echo -n -e "${YELLOW}Enter PROD_IDENT :${RESET} " 
read PROD_IDENT

echo -n -e "${YELLOW}Enter FRONT_IDENT :${RESET} " 
read FRONT_IDENT
