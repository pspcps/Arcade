...
# Shortes Way to Find Form Number: 

> If Last task is `Create Entities` Than Its Form-4
> If First task is `Create a BigQuery dataset` Than Its Form-3
> If First Task is `Create a lake in Dataplex and add a zone to your lake` Than Its Form-2
> If First Task is `Create a Cloud Storage bucket` Than Its Form-1
