...
echo -n "${RANDOM_TEXT_COLOR}${BOLD}Enter PUBLIC_BILLING_SERVICE: ${RESET}"
read PUBLIC_BILLING_SERVICE

echo -n "${RANDOM_TEXT_COLOR}${BOLD}Enter FRONTEND_STAGING_SERVICE: ${RESET}"
read FRONTEND_STAGING_SERVICE

echo -n "${RANDOM_TEXT_COLOR}${BOLD}Enter PRIVATE_BILLING_SERVICE: ${RESET}"
read PRIVATE_BILLING_SERVICE

echo -n "${RANDOM_TEXT_COLOR}${BOLD}Enter BILLING_SERVICE_ACCOUNT: ${RESET}"
read BILLING_SERVICE_ACCOUNT

echo -n "${RANDOM_TEXT_COLOR}${BOLD}Enter BILLING_PROD_SERVICE: ${RESET}"
read BILLING_PROD_SERVICE

echo -n "${RANDOM_TEXT_COLOR}${BOLD}Enter FRONTEND_SERVICE_ACCOUNT: ${RESET}"
read FRONTEND_SERVICE_ACCOUNT

echo -n "${RANDOM_TEXT_COLOR}${BOLD}Enter FRONTEND_PRODUCTION_SERVICE: ${RESET}"
