...
# Ask user for inputs
echo -ne "${BLUE_BOLD}Enter BUCKET_NAME: ${RESET}"
read -r BUCKET_NAME

echo -ne "${BLUE_BOLD}Enter TOPIC_NAME: ${RESET}"
read -r TOPIC_NAME

echo -ne "${BLUE_BOLD}Enter FUNCTION_NAME: ${RESET}"
read -r FUNCTION_NAME

echo -ne "${BLUE_BOLD}Enter REGION: ${RESET}"
read -r REGION

echo -ne "${BLUE_BOLD}Enter BUCKET_USER (email): ${RESET}"
read -r BUCKET_USER

# Start execution
echo -e "${GREEN}Starting Execution...${RESET}"
...
# Completion message
echo -e "${GREEN}-----------------------------------------------------------${RESET}"
echo -e "${GREEN}🎉 Congratulations! You’ve successfully completed the lab! 🎉${RESET}"
echo -e "${GREEN}-----------------------------------------------------------${RESET}"